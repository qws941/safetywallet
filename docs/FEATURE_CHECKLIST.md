...
- [x] 첨부 이미지
- [x] 좋아요/댓글
- [x] NEED_INFO/REJECTED 재제출 (보완 내용 입력 + 상태 PENDING 복귀 + 보너스 포인트 +2) ✅ (2026-02-25)
...
- [x] 투표 보상 설정 가능 (pointPolicies DB 조회, 하드코딩 [50,30,20] 대체 + 폴백) ✅ (2026-02-25)
- [x] 보상 푸시 알림 (투표 보상 지급 후 수상자에게 푸시 알림 발송) ✅ (2026-02-25)
- [x] 투표 동점 공정 처리 (MIN(votedAt) 기준, UUID 순서 대체) ✅ (2026-02-25)
- [x] NEED_INFO 재제출 플로우 (POST /:id/resubmit 엔드포인트, 보완 내용 UI, 상태 복귀, +2 보너스 포인트) ✅ (2026-02-25)
