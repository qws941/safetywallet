...
**Scope:** Documentation source-of-truth, runbooks, and requirement modules.
...
├── requirements/                       # PRD, checklist, modular requirement slices
...
| Modular requirement slices     | `requirements/modules/`                         | Operationally split requirement set      |
